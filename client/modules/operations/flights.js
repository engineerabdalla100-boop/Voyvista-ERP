(function () {
  ...
  function buildPayload(prefix) {
    ...
    var ccPayload = VVCustomerCode.collectPayload(prefix);
    payload.customer = ccPayload.customer || null;
    payload.original_customer_code = ccPayload.original_customer_code;
  ...
  function exportToCsv() {
    ...
    var labels = ["ID", "Date", "Ticket No.", "Route", "Passenger", "Rate", "Handling", "Net Rate", "Supplier", "Selling Rate", "Currency", "Profit", "Customer", "File #", "Note"];
    ...
    link.href = url;
    link.download = "Voyvista-Flights-Backup-" + todayISO() + ".csv";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var submitBtnDirect = document.getElementById("btn-submit-sale");
    if (submitBtnDirect) submitBtnDirect.addEventListener("click", submitSale);
    if (requestsForm) {
