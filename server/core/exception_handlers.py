"""
core/exception_handlers.py -- Central DRF exception handler.

Instead of manually logging "Access Denied" in every view that rejects
a request, this handler catches any PermissionDenied/NotAuthenticated
from anywhere in the project automatically and logs it in AuditLog --
registered once in settings.py, not repeated.
"""
